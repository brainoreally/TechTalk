...
{
public:
	static void draw(glm::vec3 position, GLfloat value, GLfloat bias, std::vector<glm::vec3> oldPositions, std::vector<GLfloat> weights);
	static void changeColour(GLfloat neuronValue);
	static void changeWeightColour(GLfloat weightValue);
	static void changeBiasColour(GLfloat biasValue);
